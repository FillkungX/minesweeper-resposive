...
<body class="bg-[#3c1414] w-full  h-full">
  ...
  <div class="flex flex-wrap items-center justify-center w-[230px] ml-[55px] -mt-[450px] sss:ml-[20vw] ss:ml-[22vw] ss:-mt-[600px] ss:w-[250px] sl:ml-[30vw] sl:-mt-[450px] md:w-[450px] md:ml-[22vw] md:-mt-[100vh]  lg:ml-[10vw] lg:-mt-[35vh] sxl:ml-[15vw] sxl:-mt-[58vh] xl:ml-[30vw]">
